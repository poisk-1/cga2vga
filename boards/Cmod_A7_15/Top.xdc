...
## LEDs
set_property -dict {PACKAGE_PIN A17 IOSTANDARD LVCMOS33} [get_ports io_valid_0]
#set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 } [get_ports { led[1] }]; #IO_L13P_T2_MRCC_16 Sch=led[2]

## RGB LED
set_property -dict {PACKAGE_PIN B17 IOSTANDARD LVCMOS33} [get_ports dout_0[0]]
set_property -dict {PACKAGE_PIN B16 IOSTANDARD LVCMOS33} [get_ports dout_0[1]]
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports dout_0[2]]
...
set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS33} [get_ports io_genSync_1_0]
set_property -dict {PACKAGE_PIN U2 IOSTANDARD LVCMOS33} [get_ports io_genSync_0_0]
set_property -dict {PACKAGE_PIN W6 IOSTANDARD LVCMOS33} [get_ports io_genRgb1_2_0]
set_property -dict {PACKAGE_PIN U3 IOSTANDARD LVCMOS33} [get_ports io_genRgb1_1_0]
